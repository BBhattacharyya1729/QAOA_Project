...
"""
Brute-force max solve a 01 QUBO.
"""
...
"""
Brute-force max solve a pm QUBO.
"""
...
"""
Bruteforce maxcut for adj. matrix A by mapping to pm QUBO
"""
def brute_force_maxcut(A):
    return brute_force_maxpm(-1/4 * A)
...
"""
def vertex_on_top(theta_list,rotation = None):
    if(rotation is None):
        return theta_list
    else:
        if(theta_list.ndim == 1):
